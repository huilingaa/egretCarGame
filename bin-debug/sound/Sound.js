...
var Sound = (function (_super) {
    ...
    //更新进度
    Sound.prototype.onTimeUpdate = function (e) {
        var position = this._channel ? this._channel.position : 0;
        this.setProgress(position);
    };
    Sound.prototype.setProgress = function (position) {
    ...
    Sound.prototype.setAllAbled = function (isPlaying) {
    ...
    Sound.prototype.setTextAbled = function (text, touchEnabled) {
